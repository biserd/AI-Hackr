...
export const SIGNATURE_DB: TechSignature[] = [
  ...
  // Payments
  {
    ...
    rules: [
      ...
      { type: "html", pattern: "checkout\\.stripe\\.com", weight: 0.9 },
      { type: "script_src", pattern: "stripe\\.com/v3", weight: 0.9 },
      { type: "html", pattern: "stripe-js", weight: 0.6 },
      { type: "html", pattern: "pk_live_", weight: 0.95 },
      { type: "html", pattern: "pk_test_", weight: 0.95 },
      { type: "html", pattern: "Stripe\\(", weight: 0.8 },
      { type: "html", pattern: "redirectToCheckout", weight: 0.85 },
      { type: "html", pattern: "createPaymentMethod", weight: 0.85 },
      { type: "html", pattern: "StripeProvider", weight: 0.8 },
      { type: "html", pattern: "CardElement", weight: 0.8 },
      { type: "html", pattern: "PaymentElement", weight: 0.8 },
      { type: "html", pattern: "buy\\.stripe\\.com", weight: 0.9 },
      { type: "html", pattern: "billing\\.stripe\\.com", weight: 0.9 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    category: "payments",
    rules: [
      { type: "script_src", pattern: "gumroad\\.com", weight: 0.9 },
      { type: "html", pattern: "gumroad", weight: 0.5 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
  ...
  },
  {
    ...
    category: "auth",
    rules: [
      { type: "script_src", pattern: "kinde\\.com", weight: 0.9 },
      { type: "html", pattern: "@kinde", weight: 0.7 },
      { type: "html", pattern: "kinde-auth", weight: 0.8 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    category: "auth",
    rules: [
      { type: "script_src", pattern: "magic\\.link", weight: 0.9 },
      { type: "html", pattern: "magic-sdk", weight: 0.8 },
      { type: "script_src", pattern: "auth\\.magic\\.link", weight: 0.9 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    category: "auth",
    rules: [
      { type: "html", pattern: "lucia-auth", weight: 0.8 },
      { type: "html", pattern: "@lucia-auth", weight: 0.8 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    category: "auth",
    rules: [
      { type: "script_src", pattern: "stytch\\.com", weight: 0.9 },
      { type: "html", pattern: "stytch", weight: 0.5 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    category: "auth",
    rules: [
      { type: "script_src", pattern: "workos\\.com", weight: 0.9 },
      { type: "html", pattern: "@workos", weight: 0.7 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    category: "auth",
    rules: [
      { type: "script_src", pattern: "propelauth\\.com", weight: 0.9 },
      { type: "html", pattern: "@propelauth", weight: 0.7 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
...
export const AI_SIGNATURES: AISignature[] = [
  ...
  },
  {
    ...
    rules: [
      ...
      { type: "html", pattern: "@langchain", weight: 0.8 },
      { type: "html", pattern: "LangChainHub", weight: 0.8 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    name: "LlamaIndex",
    rules: [
      { type: "html", pattern: "llamaindex", weight: 0.7 },
      { type: "script_src", pattern: "llamaindex", weight: 0.7 },
      { type: "html", pattern: "llama-index", weight: 0.7 },
      { type: "html", pattern: "llama_index", weight: 0.7 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    name: "AWS Bedrock",
    rules: [
      { type: "html", pattern: "bedrock-runtime", weight: 0.9 },
      { type: "html", pattern: "@aws-sdk/client-bedrock", weight: 0.9 },
      { type: "html", pattern: "BedrockRuntimeClient", weight: 0.9 },
      { type: "html", pattern: "invokeModel", weight: 0.6 },
      { type: "network", pattern: "bedrock\\..*\\.amazonaws\\.com", weight: 0.95 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    rules: [
      { type: "html", pattern: "aiplatform\\.googleapis\\.com", weight: 0.9 },
      { type: "html", pattern: "@google-cloud/aiplatform", weight: 0.9 },
      { type: "html", pattern: "vertexai", weight: 0.7 },
      { type: "html", pattern: "VertexAI", weight: 0.8 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    name: "OpenRouter",
    rules: [
      { type: "html", pattern: "openrouter\\.ai", weight: 0.9 },
      { type: "network", pattern: "openrouter\\.ai", weight: 0.95 },
      { type: "html", pattern: "@openrouter", weight: 0.8 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    name: "LiteLLM",
    rules: [
      { type: "html", pattern: "litellm", weight: 0.7 },
      { type: "html", pattern: "LiteLLM", weight: 0.7 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    name: "ElevenLabs",
    rules: [
      { type: "html", pattern: "elevenlabs", weight: 0.7 },
      { type: "script_src", pattern: "elevenlabs", weight: 0.8 },
      { type: "html", pattern: "api\\.elevenlabs\\.io", weight: 0.9 },
      { type: "network", pattern: "elevenlabs\\.io", weight: 0.9 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    name: "Deepgram",
    rules: [
      { type: "html", pattern: "deepgram", weight: 0.7 },
      { type: "script_src", pattern: "deepgram", weight: 0.8 },
      { type: "html", pattern: "api\\.deepgram\\.com", weight: 0.9 },
      { type: "network", pattern: "deepgram\\.com", weight: 0.9 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    name: "AssemblyAI",
    rules: [
      { type: "html", pattern: "assemblyai", weight: 0.7 },
      { type: "script_src", pattern: "assemblyai", weight: 0.8 },
      { type: "html", pattern: "api\\.assemblyai\\.com", weight: 0.9 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    name: "Pinecone",
    rules: [
      { type: "html", pattern: "pinecone", weight: 0.6 },
      { type: "script_src", pattern: "@pinecone-database", weight: 0.8 },
      { type: "html", pattern: "pinecone\\.io", weight: 0.8 },
      { type: "network", pattern: "pinecone\\.io", weight: 0.9 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    name: "Chroma",
    rules: [
      { type: "html", pattern: "chromadb", weight: 0.8 },
      { type: "html", pattern: "chroma-core", weight: 0.8 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    name: "Weaviate",
    rules: [
      { type: "html", pattern: "weaviate", weight: 0.7 },
      { type: "script_src", pattern: "weaviate", weight: 0.8 },
      { type: "network", pattern: "weaviate\\.io", weight: 0.9 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    name: "Dify",
    rules: [
      { type: "html", pattern: "dify\\.ai", weight: 0.9 },
      { type: "script_src", pattern: "dify", weight: 0.7 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    name: "Flowise",
    rules: [
      { type: "html", pattern: "flowise", weight: 0.7 },
      { type: "script_src", pattern: "flowise", weight: 0.8 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    name: "Portkey",
    rules: [
      { type: "html", pattern: "portkey\\.ai", weight: 0.9 },
      { type: "html", pattern: "@portkey-ai", weight: 0.9 },
      { type: "network", pattern: "portkey\\.ai", weight: 0.95 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
  {
    ...
    name: "Helicone",
    rules: [
      { type: "html", pattern: "helicone\\.ai", weight: 0.9 },
      { type: "html", pattern: "@helicone", weight: 0.9 },
      { type: "network", pattern: "helicone\\.ai", weight: 0.95 },
    ],
    thresholds: { high: 0.8, medium: 0.5 },
  },
];
